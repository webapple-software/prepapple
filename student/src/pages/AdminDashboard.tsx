...
export default function AdminDashboard() {
  const [activeTab, setActiveTab] = useState<'analytics' | 'students' | 'question_bank'>('analytics');
      ...
      <aside className="w-72 bg-[#0f294a] text-white flex flex-col justify-between border-r border-blue-950 flex-shrink-0 select-none">
        ...
        <div className="p-4 border-t border-blue-950 space-y-1.5">
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-xs font-bold uppercase tracking-wider text-purple-300 hover:bg-[#1a3a60] hover:text-white transition-all cursor-pointer"
          >
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-xs font-bold uppercase tracking-wider text-blue-300 hover:bg-[#1a3a60] hover:text-white transition-all cursor-pointer"
          >
                  ...
                  <div className="space-y-4">
                    <div>
                      <div className="flex justify-between items-center text-xs font-bold text-gray-600 mb-1.5">
                        <span>JEE Mock Papers</span>
                        <span>{tests.filter(t => (t.category || 'JEE') === 'JEE').length} Tests</span>
                      </div>
                        ...
                        <div 
                          ...
                          style={{ 
                            width: `${tests.length > 0 
                              ? (tests.filter(t => (t.category || 'JEE') === 'JEE').length / tests.length) * 100 
                              : 0}%` 
                          }}
                        ></div>
                      </div>
                    ...
                    <div>
                      <div className="flex justify-between items-center text-xs font-bold text-gray-600 mb-1.5">
                        <span>NEET Mock Papers</span>
                        <span>{tests.filter(t => (t.category || 'JEE') === 'NEET').length} Tests</span>
                      </div>
                      <div className="w-full bg-slate-100 h-2.5 rounded-full overflow-hidden">
                        <div 
                          ...
                          style={{ 
                            width: `${tests.length > 0 
                              ? (tests.filter(t => (t.category || 'JEE') === 'NEET').length / tests.length) * 100 
                              : 0}%` 
                          }}
                        ></div>
                      </div>
